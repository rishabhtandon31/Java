		...
		while(choice.compareToIgnoreCase("y")==0){
			...
			case 1: 
				try {
					...
					System.out.println("Associate details of associate id: " + payrollServices.acceptAssociateDetails("Rishabh", "Tandon", "rishabh@gmail.com", "ADM", "Sr. Analyst", "HGGJ2664F",  200000, 30000, 2000, 1000, 96889056, "HDFC", "HDFC000798") + " added.");
					//System.out.println(payrollServices.getAssociateDetails(101).toString());
				} catch (PayrollServicesDownException e) {
					System.out.println("Associate Data can't be entered.");
					e.printStackTrace();
				}
				break;
			...
			case 4:
				try {
					...
					for(int i=0;i<length;i++){
						payrollServices.calculateNetSalary(associates.get(i).getAssociateID());
						System.out.println("Details of Associate with id : "+associates.get(i).getAssociateID());
						printDetails(associates.get(i));
					}
				} catch (PayrollServicesDownException e) {
