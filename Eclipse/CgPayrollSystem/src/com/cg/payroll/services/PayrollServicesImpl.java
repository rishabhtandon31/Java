...
public class PayrollServicesImpl implements PayrollServices{
	...
	public double calculateNetSalary(int associateId)
		...
		//Tax Calculation
		double netSalaryAfterInvesting = annualGrossSalary - ((associate.getYearlyInvestmentUnder8oC()>(150000-associate.getSalary().getEpf()-associate.getSalary().getCompanyPf())?(150000):(associate.getYearlyInvestmentUnder8oC())));
		double annualTax = 0;
